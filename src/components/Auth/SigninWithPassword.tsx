...
export default function SigninWithPassword() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <form className=" border rounded-2xl p-4 shadow-md text-center w-1/3">
        <div className="mb-4">
          <label
            htmlFor="email"
        ...
        {!loader ? <button onClick={(e) => handleAuth(e)} className="w-1/2 py-3 mb-4 text-center text-sm font-medium text-white bg-blue-700 hover:bg-blue-800 rounded-lg">
          Sign In
        </button>
          :
          <button disabled type="button" className="text-white text-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">
