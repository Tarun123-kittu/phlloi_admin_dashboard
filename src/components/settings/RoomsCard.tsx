        ...
        <div>
            <div className=" rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="p-5 flex justify-between ">
                    ...
                    <div>
                            <a onClick={() => {setIsOpen(true)}} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-black  bg-gradient-to-r from-[#fbb90d] to-[#22ebff] rounded-lg cursor-pointer focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Edit
