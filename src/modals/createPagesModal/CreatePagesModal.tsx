            ...
            {isOpen && (
              ...
              >
                ...
                <span className="sr-only">Close modal</span>
                            ...
                            <button onClick={() => handleAddOneMorePage()} type="button" className="text-center text-sm font-medium text-black rounded  bg-gradient-to-r from-[#fbb90d] to-[#22ebff] ml-auto w-24 h-10">Add Page</button>
                           ...
                           <button
                            ...
                            <button disabled type="button" className="text-center text-sm font-medium text-black rounded  bg-gradient-to-r from-[#fbb90d] to-[#22ebff] w-full">
